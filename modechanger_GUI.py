...
syx_messages = {
    ...
    #"master_tune": [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x00, tune_upper, tone_lower, 0xF7],
    "key_trnspse": {
             "G" : [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x08, 0x05, 0xF7],
             "Ab": [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x04, 0x00, 0xF7],
             "A" : [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x03, 0x00, 0xF7],
             "Bb": [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x02, 0x00, 0xF7],
             "B" : [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x01, 0x00, 0xF7],
             "C" : [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x00, 0x00, 0xF7],
             "C#": [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x01, 0x00, 0xF7],
             "D" : [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x02, 0x00, 0xF7],
             "Eb": [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x03, 0x00, 0xF7],
             "E" : [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x04, 0x00, 0xF7],
             "F" : [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x05, 0x00, 0xF7],
             "F#": [0xF0, 0x44, 0x03, 0x00, midi_channel, 0x40, 0x01, 0x06, 0x00, 0xF7],
    },
...
transpose_selector.currentIndexChanged.connect(lambda: midiout.send_message(syx_messages["key_trnspse"]["transpose_selector.currentIndex"]))

"""
Buttons
"""

key_trnspse_button = QPushButton("Key Transpose")
key_trnspse_button.clicked.connect(lambda: midiout.send_message(syx_messages["key_trnspse"]["G"]))
...
top_box.addWidget(key_trnspse_button)
